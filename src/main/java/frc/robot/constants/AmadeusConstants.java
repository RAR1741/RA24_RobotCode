...
public final class AmadeusConstants {
  ...
  public static class Auto {
    ...
    public static final double k_maxModuleSpeed = 5.0; // Meters per second
    ...
    public static final Pose2d k_redCenterPose2d = new Pose2d(15.19, 5.50, new Rotation2d(Units.degreesToRadians(180.0)));

    public static final Pose2d k_blueCenterPose2d = new Pose2d(1.27, 5.50, new Rotation2d(0));
  }
  ...
  public class SwerveDrive {
    ...
    // Max acceleration
    public static final double k_maxLinearAcceleration = 12.0; // Meters per second^2
    public static final double k_maxAngularAcceleration = Math.PI * 8.0; // Radians per second^2
  ...
  public class AutoAim {
    ...
    public static final double k_maxLinearAcceleration = 1.5; // Meters per second^2

    // Max rotation
    public static final double k_maxAngularSpeed = Math.PI * 2 * 1.5; // Radians per second (540 degrees per second)
    public static final double k_maxAngularAcceleration = Math.PI * 2 * 2; // Radians per second^2 (720 degrees per second^2)
