...
public final class AmadeusConstants {
  ...
  // public static final double k_maxAngularSpeed = Math.PI * 2.0; // Radians per
  // second

  // // Max acceleration
  // public static final double k_maxLinearAcceleration = 12.0; // Meters per
  // second squared
  ...
  // public static final double k_driveGearRatio = (50.0 / 14.0) * (16.0 / 28.0) *
  // (45.0 / 15.0);
  ...
  // public static final double k_autoAimOmegaRPSThreshold = Math.PI / 8; // in
  // radians
  // public static final double k_autoAimAngleTolerance =
  // Units.degreesToRadians(3.0);

  // // Max speed
  // public static final double k_maxSpeed = 3.0; // Meters per second
  // public static final double k_maxLinearAcceleration = 1.5; // Meters per
  // second squared

  // // Max rotation
  // public static final double k_maxAngularSpeed = Math.PI * 2 * 1.5; // Radians
  // per second (540 degrees per second)
  // public static final double k_maxAngularAcceleration = Math.PI * 2 * 2; //
  // Radians per second squared (720 degrees
  // // per second squared)

  // // Use these values as overrides in DriveTrajectoryTask
  // // These are the current PathPlanner values
  // // public static final PathConstraints k_pathConstraints = new
  // PathConstraints(
  // // k_maxSpeed,
  ...
  // public static final double k_pivotMotorKA = 0.0; // 0.02; // volts*sec^2 /
  // rad
  ...
  // public static final int k_sensorThreshold = 1000; // 1,000 is "in", 2000 is
  // max
  ...
  // public static final int k_shooterSpeedTolerance = 100; // 1,000 is "in", 2000
  // is max
  ...
  // public static final double k_ampPivotAngle = 0.0; // TODO: get amp pivot
  // angle
  ...
  // public static final double k_relRotationsToMaxExtension =
  // maxPivotExtensionInches * k_rotationsPerInch;
