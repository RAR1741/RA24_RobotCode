      ...
      new SysIdRoutine.Mechanism(
          ...
          log -> {
            ...
            log.motor("turn-frontleft")
                ...
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_LEFT].getTurnVelocity(),
                        MetersPerSecond));
            ...
            log.motor("turn-frontright")
                ...
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_RIGHT].getTurnVelocity(),
                        MetersPerSecond));
            ...
            log.motor("turn-backright")
                ...
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_RIGHT].getTurnVelocity(),
                        MetersPerSecond));
            ...
            log.motor("turn-backleft")
                ...
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_LEFT].getTurnVelocity(),
                        MetersPerSecond));
      ...
      new SysIdRoutine.Mechanism(
          ...
          log -> {
            ...
            log.motor("drive-frontleft")
                ...
                .linearPosition(
                    m_distance.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_LEFT].getDrivePosition(), Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_LEFT].getDriveVelocity(),
                        MetersPerSecond));
            ...
            log.motor("drive-frontright")
                ...
                .linearPosition(
                    m_distance.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_RIGHT].getDrivePosition(), Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.FRONT_RIGHT].getDriveVelocity(),
                        MetersPerSecond));
            ...
            log.motor("drive-backright")
                ...
                .linearPosition(
                    m_distance.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_RIGHT].getDrivePosition(), Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_RIGHT].getDriveVelocity(),
                        MetersPerSecond));
            ...
            log.motor("drive-backleft")
                ...
                .linearPosition(
                    m_distance.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_LEFT].getDrivePosition(), Meters))
                .linearVelocity(
                    m_velocity.mut_replace(
                        m_modules[SwerveDrive.Module.BACK_LEFT].getDriveVelocity(),
                        MetersPerSecond));
